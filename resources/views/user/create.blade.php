                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                ...
                                <input type="checkbox" class="custom-control-input" id="status" name="status" checked value="active">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" id="password" name="password" class="form-control" required value="" minlength="8" maxlength="255" placeholder="@lang('messages.password')...">
                        </div>
                        <div class="form-group">
                            <label for="password_confirmation">@lang('messages.confirmPassword')</label>
                            <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" minlength="8" maxlength="255" required value="" placeholder="@lang('messages.confirmPassword')...">
                        </div>
                    </div>
                </div>
            </div>
